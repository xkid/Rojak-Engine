  ...
  // Use this PHP File As your Development
    ...
    if (file_exists('configuration.php')){
      $user = new flexibleAccess('', $settings);
		...
		// Load Your HTML file
		$TBS->LoadTemplate('./template/sample-protected-page.html');    // <----- Place this script HTML
	...
	if ($user->is_loaded()){
      ...
      $message .= $user->get_property('username') . ", This is Protected Page, user must login to view<br>";
      $message .= "<a href='index.php'>Home</a><br>";
      $message .= "<a href='sample-protected-page.php'>Protected Page</a><br>";
      $message .= "<a href='sample-login.php?logout=1'>Logout</a><br>";
    
    }else{
    
      header("Location: sample-login.php"); /* Redirect browser */
      exit();
