...
/*                           */
/*****************************/
OutputItemBusiness    = 'Your Email for PayPal'; /* Business name for PayPal */
OutputItemCurrency    = 'MYR'; /* Currency for PayPal - defaults to USD */
OutputItemReturn      = 'http://code.google.com/p/xinix/'; /* Return URL for PayPal */
...
function CheckoutCart(Option) {
   ...
   for ( i = 1; i <= iNumberOrdered; i++ ) {
      ...
      /*if ( PaymentProcessor != '' ) {
         ...
         strOutput += "<input type=hidden name=\"" + OutputItemAddtlInfo + strFooter + "\" value=\"" + fields[5] + "\">";
          ...
          /***********************************/
          /*                                 */
          /*  for paypal, set the ON0        */
          /*  variable to support any OS0    */
          /*  data in ADDITIONALINFO         */
          /*                                 */
          /***********************************/			 
          strOutput += "<input type=hidden name=\"on0_" + strFooter + "\" value=\"options\">";
   ...
   if ( bDisplay ) {
      ...
      /*                                 */
      /***********************************/	    		 
      } else if ( PaymentProcessor == 'pp' && Option == 'paypal') {
         //Process this for Paypal         
         strOutput += "<input type=hidden name=\"cmd\" value=\"_cart\">";
         strOutput += "<input type=hidden name=\"upload\" value=\"1\">";
         strOutput += "<input type=hidden name=\"business\" value=\"" + OutputItemBusiness + "\">";
         strOutput += "<input type=hidden name=\"handling_cart\" value=\"" + strShipping + "\">";
         strOutput += "<input type=hidden name=\"no_shipping\" value=\"0\" />";
         //strOutput += "<input type=hidden name=\"item_name\" value=\"On-Line Order Payment\">";
         //strOutput += "<input type=hidden name=\"amount\" value=\"" + strTotal + "\">";
         strOutput += "<input type=hidden name=\"currency_code\" value=\"" + OutputItemCurrency + "\">";
         strOutput += "<input type=hidden name=\"return\" value=\"" + OutputItemReturn + "\">";
